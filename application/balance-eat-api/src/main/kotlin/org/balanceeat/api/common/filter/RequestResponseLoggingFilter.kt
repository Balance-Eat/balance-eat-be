package org.balanceeat.api.common.filter
...
import org.balanceeat.api.common.notification.ErrorNotificationSender
...
class RequestResponseLoggingFilter(
    ...
    override fun doFilterInternal(
        ...
        if (!request.requestURI.contains("/v1") && !request.requestURI.contains("/admin")) {
